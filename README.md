...
- DOM Elements:
    - Select the HTML element with the CLASS "chessboard" to render the chessboard (const boardElement = document.querySelector(".chessboard");).
...
- Handling Moves:
    ...
    - Construct a move object containing the source and target squares.
